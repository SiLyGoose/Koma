 ...
 * 9 (the default) squeezes hardest, and a big picture is much faster to make at 6 for almost the same size.
 */
export function encodePng(width: number, height: number, rgba: Uint8Array, level = 9): Buffer {
