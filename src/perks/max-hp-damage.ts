 ...
 * 3,720 HP boss is about 19). Added after boosts, rallies and crits, so it stays that share.
 * Its own mechanic, in lib/events/raid.ts.
 */
export const maxHpDamage = definePerk({
  description: "Raid: extra damage on each of the wearer's attacks, as a share of the boss's max HP (added after boosts, rallies and crits).",
